...
### 4. Display full playlist title (Home page)
- Disabled: Defaults only displays 2 lines and an ellipsis at the end when the name is too long
...
### 5. Display full playlist info
- Disabled: Defaults only displays 1 lines and an ellipsis at the end when the name is too long
  - Home:
...
### 7. Display full channel info (under testing, temporary disabled)
### 8. Fix "Join" Membership button (under testing, temporary disabled)
...
- Disabled: Default with no persistent progress bar when control bar was hidden
...
- Enabled: Customized persistent progress bar in YouTube's signature red color
...
- Disabled: Default with no functional button that redirect to '/watch' view
...
- Disabled: Default with no functional button that redirect to pure video URL
  - Normal playlist:
